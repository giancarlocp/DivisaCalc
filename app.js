...
let fx=e=>Math.round(1e5*e)/1e5,conv=(e,t,n)=>(u,o)=>t==o?n:fx(e[t+o](n)),num=e=>""==e?0:parseFloat(e),styl=e=>e<0?"background:tomato":"",noedit=e=>m(".item",{style:styl(e)},e),input_=e=>(t,n)=>m("input.item",{type:"number",style:styl(t),value:t,id:n,oninput:e}),noRow=({u:e,b:t,c:n},u,o)=>[noedit(e),noedit(t),noedit(n),m("label",o)],row_=e=>({u:t,b:n,c:u},o,c)=>[e(t,o+"u"),e(n,o+"b"),e(u,o+"c"),m(c?"label.v":"",c)]
...
function r({target:{value:e,id:t}}){e=num(e);let[u,c]=t;n[u][c]=e,"f"==u?b(c,e):"e"==u?o(u,c,e):l()}input_(r);let a=row_(input_(r))
return{view:({attrs:u})=>(e=u.u2b,t=u.c2b,b(n.r,n.f[n.r]),m(".container",[m("label","$"),m("label","Bs"),m("label","Co"),m(""),a(n.f,"f","Fact"),a(n.p,"p","Pago"),noRow(n.v,"v","Vuelto"),hideRow,a(n.d,"d","Devol"),noRow(n.c,"c","Cierre"),hideRow,a(n.e,"e")]))}}
function App(){let e={u2b:200,c2b:50}
